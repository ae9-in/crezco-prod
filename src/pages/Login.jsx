  ...
  const handleSignUp = async (e) => {
    ...
    try {
      ...
      if (authData?.user) {
        ...
        setSuccess(true);
        setUser({ ...authData.user, name, role: 'member' });
  ...
  const handleLogin = async (e) => {
    ...
    try {
      ...
      if (authData?.user) {
        ...
        const profile = await userApi.getUserProfile(authData.user.id);
      ...
      <main className="flex-grow pt-32 pb-20 px-4 flex items-center justify-center relative overflow-hidden">
        ...
        <div className="max-w-xl w-full relative z-10">
          <div className="bg-[#0D0F1A]/80 backdrop-blur-2xl border border-white/10 rounded-[2.5rem] p-8 sm:p-12 shadow-[0_0_100px_rgba(0,0,0,0.5)] overflow-hidden relative group">
            ...
            {error && (
              <div className="mb-8 p-5 bg-red-500/10 border border-red-500/20 rounded-[1.5rem] text-red-400 text-sm flex items-start gap-4">
            ...
            {success && (
              <div className="mb-8 p-5 bg-green-500/10 border border-green-500/20 rounded-[1.5rem] text-green-400 text-sm flex items-start gap-4">
            ...
            <div className="mt-12">
              ...
              <div className="grid grid-cols-2 gap-4">
                <button 
                  ...
                  className="flex items-center justify-center space-x-2 py-4 bg-white/5 border border-white/10 rounded-2xl hover:bg-white/10 transition-all"
                >
