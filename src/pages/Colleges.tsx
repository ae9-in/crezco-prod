...
import { joinCollege } from '../lib/api';
...
const Colleges: React.FC = () => {
  ...
  const handleCreateCollege = async (e: React.FormEvent) => {
    e.preventDefault();
    if (!collegeName.trim() || !user) return;
      ...
      <main className="flex-grow pt-28 pb-20 px-4 sm:px-6 lg:px-8 max-w-7xl mx-auto w-full">
        ...
        <section className="mb-12">
          <div className="flex flex-col lg:flex-row gap-6">
            ...
            {/* Quick Create - Simplified for Desktop, Button for Mobile */}
                ...
                >
                  ...
                  <div className="p-8 space-y-6">
                    ...
                    <div className="flex items-center justify-between">
                       <div className="flex items-center space-x-2">
                          ...
                          <span className="text-xs font-bold text-gray-500">
                            {college.memberships?.length || 0} Members
                          </span>
                       </div>
                    ...
                    <div className="grid grid-cols-2 gap-3 pt-4">
                      ...
                      {memberColleges.has(college._id || (college.id && college.id.toString())) ? (
        ...
        <section className="mt-24 p-8 sm:p-16 bg-gradient-to-r from-[#FF2BCD]/10 via-[#8A2FFF]/10 to-[#32F5FF]/10 rounded-[3rem] border border-white/5 relative overflow-hidden">
           ...
           <div className="max-w-2xl relative z-10 space-y-8">
              ...
              <button 
                onClick={() => window.location.href='/campus-coordinator'}
